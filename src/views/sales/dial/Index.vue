<template>
  <a-card :bordered="false">
      ...
      <a-row class="row-item-search">
        ...
        <a-form class="search-form" :form="searchForm" layout="inline" @submit="handleSearch">
          <a-form-item label="关键词">
            <a-input v-decorator="['cname']" placeholder="请输入关键词" />
          </a-form-item>
          <a-form-item label="奖项类型">
            <a-select v-decorator="['cateid', { initialValue: -1 }]">
              ...
              <a-select-option :value="3">产品</a-select-option>
              <a-select-option :value="4">谢谢惠顾</a-select-option>
            </a-select>
          </a-form-item>
    ...
    <s-table
      ...
      :pageSize="15"
    >
      <div slot="value_item" slot-scope="item">
        ...
        <div v-else-if="item.coupon_id" class="">
          <div>优惠券: <span style="color: red;">{{ item.name }}</span></div>
        </div>
  ...
  data () {
    return {
      ...
      columns: [
        ...
        {
          title: '奖项数据',
          dataIndex: 'value_item',
          scopedSlots: { customRender: 'value_item' }
        },
        {
          title: '操作',
          dataIndex: 'action',
