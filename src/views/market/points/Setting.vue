      ...
      <a-form :form="form" @submit="handleSubmit">
        ...
        <div v-show="form.getFieldValue('is_shopping_gift') == 1">
          <a-form-item label="积分赠送比例" :labelCol="labelCol" :wrapperCol="wrapperCol">
            ...
            <div class="form-item-help">
              ...
              <p class="extra">例：订单付款金额(100.00{{currency_short}}) * 积分赠送比例(100%) = 实际赠送的积分(100积分)</p>
            </div>
          </a-form-item>
        </div>
        ...
        <div v-show="form.getFieldValue('is_shopping_discount') == 1">
          <a-form-item label="积分抵扣比例" :labelCol="labelCol" :wrapperCol="wrapperCol">
            ...
            />
            <div class="form-item-help">
              <small>例如：设置1个积分可抵扣0.1{{ currency_short }}，则10积分可抵扣1{{ currency_short }}，100积分可抵扣10{{ currency_short }}</small>
            </div>
          </a-form-item>
          <a-form-item label="最高可抵扣金额" :labelCol="labelCol" :wrapperCol="wrapperCol">
            ...
            <a-form-item>
              ...
              />
              <div class="form-item-help">
                <small>例如：设置最高可抵扣10%，订单金额100{{ currency_short }}，此时用户可抵扣10{{ currency_short }}</small>
              </div>
            </a-form-item>
          </a-form-item>
        </div>
