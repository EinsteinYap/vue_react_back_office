  ...
  <a-card :bordered="false">
    ...
    <a-spin :spinning="isLoading">
      <a-form :form="form" @submit="handleSubmit">
        <a-form-item label="自购金额" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number
            :min="0"
            v-decorator="['self_buy.money', { initialValue: 0, rules: [{ required: true, message: '请输入自购金额' }] }]"
          />

        </a-form-item>
        <a-form-item label="赠送次数" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number
            :min="0"
            v-decorator="['self_buy.num', { initialValue: 0, rules: [{ required: true, message: '请输入赠送次数' }] }]"
          />
          <span style="margin-left: 10px;">次</span>
        </a-form-item>
        <a-form-item label="下级购买金额" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number
            :min="0"
            v-decorator="['child_buy.money', { initialValue: 0, rules: [{ required: true, message: '请输入下级购买金额' }] }]"
          />
        ...
        <a-form-item label="赠送次数" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number
            :min="0"
            v-decorator="['child_buy.num', { initialValue: 0, rules: [{ required: true, message: '请输入赠送次数' }] }]"
          />
          <span style="margin-left: 10px;">次</span>
        </a-form-item>
