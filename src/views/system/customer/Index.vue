      ...
      <a-row class="row-item-search">
        ...
        <a-form class="search-form" :form="searchForm" layout="inline" @submit="handleSearch">
          <a-form-item label="名称">
            <a-input v-decorator="['cname']" placeholder="请输入搜索名称" />
          </a-form-item>
<!--          <a-form-item label="所属代理ID">-->
<!--            <a-input v-decorator="['agent_id']" placeholder="请输入所属代理ID(限数字)" />-->
<!--          </a-form-item>-->
    ...
    >
      ...
      <div slot="image_url" slot-scope="text">
      ...
      <div slot="agent" slot-scope="item">
        <span>{{ item.agent_id == 0 ? '平台' : item.agent.user_name }}</span>
      </div>
