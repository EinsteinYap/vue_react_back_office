  ...
  >
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="直属分红" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <InputNumberGroup
            addonAfter="%"
            :inputProps="{ min: 0, max: 100, step: 0.01 }"
            v-decorator="['bonus', { rules: [{ required: true, message: '直属分红比例不能为空' }] }]"
          />
          <div class="form-item-help">
            <p class="extra">直属分红范围0-100，例如: 98%，0代表不分红</p>
          </div>
        </a-form-item>
