  ...
  >
    <a-spin :spinning="confirmLoading">
      ...
      <a-form :form="form">
        ...
        <a-form-item label="SVIP等级" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select
            placeholder="请选择SVIP等级"
            v-decorator="['vip_grade_id', { rules: [{ required: true }] }]"
          >
...
export default {
  ...
  methods: {
    ...
    setFieldsValue () {
      ...
      this.$nextTick(() => {
        setFieldsValue(pick(record, ['vip_grade_id']))
      })
    },
    ...
    */
    onFormSubmit (values) {
      ...
      Api.setsvip({ userId: this.record.user_id, form: values })
        .then((result) => {
          // 显示成功
