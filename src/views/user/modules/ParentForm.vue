  ...
  >
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="上级用户ID" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input
            v-decorator="['parent_id', {rules: [{required: true, message: '请输入正确的ID'}]}]"
          />
        </a-form-item>
      </a-form>
    </a-spin>
...
export default {
  ...
  methods: {
    ...
    onFormSubmit (values) {
      ...
      Api.setParentId({ user_id: this.record.user_id, form: values })
        .then((result) => {
          // 显示成功
