  ...
  >
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item class="mt-40" label="简介" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-textarea :autoSize="{ minRows: 4, maxRows: 6 }" v-decorator="['synopsis']" />
        </a-form-item>
        ...
        <a-form-item label="语言选择" :labelCol="labelCol" :wrapperCol="wrapperCol" extra="每个文章只能选择单个语言,如需多语言请添加多个文章">
        ...
        <a-form-item label="推荐" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-radio-group v-decorator="['is_hot', {initialValue: 1, rules: [{required: true}]}]">
            <a-radio :value="1">是</a-radio>
            <a-radio :value="0">否</a-radio>
          </a-radio-group>
        </a-form-item>
        <a-form-item label="置顶" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-radio-group v-decorator="['is_top', {initialValue: 1, rules: [{required: true}]}]">
            <a-radio :value="1">是</a-radio>
            <a-radio :value="0">否</a-radio>
          </a-radio-group>
        </a-form-item>
    ...
    setFieldsValue () {
      ...
      this.$nextTick(() => {
        setFieldsValue(pick(this.record, [
          ...
          'is_hot', 'is_top', 'language_id', 'synopsis'
        ]))
      })
    },
