    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-tabs :activeKey="activeKey" @change="onChangeTabs">
          ...
          <a-tab-pane :key="RECHARGE_TYPE_POINTS" tab="充值红包余额">
            <template v-if="activeKey === RECHARGE_TYPE_POINTS">
              <a-form-item class="mb-5" label="会员ID" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <span>{{ record.id }}</span>
              </a-form-item>
              <a-form-item class="mb-5" label="当前红包余额" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <span class="c-p">{{ record.red_paper }}</span>
              </a-form-item>
              <a-form-item label="充值方式" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-radio-group
...
// 充值类型枚举: 红包
const RECHARGE_TYPE_POINTS = 'red_paper'
