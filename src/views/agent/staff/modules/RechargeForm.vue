          ...
          <a-tab-pane :key="RECHARGE_TYPE_BALANCE" tab="充值余额">
            <template v-if="activeKey === RECHARGE_TYPE_BALANCE">
              ...
              <a-form-item label="变更金额" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-input-number
                  :min="0.01"
                  v-decorator="[`${RECHARGE_TYPE_BALANCE}.value`, { initialValue: '', rules: [{ required: true, message: '请输入变更的金额' }] }]"
                />
              </a-form-item>
...
<!--            </template>-->
<!--          </a-tab-pane>-->
<!--          <a-tab-pane :key="RECHARGE_TYPE_SlYDER" tab="充值大转盘">-->
<!--            <template v-if="activeKey === RECHARGE_TYPE_SlYDER">-->
<!--              <a-form-item class="mb-5" label="会员ID" :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <span>{{ record.id }}</span>-->
<!--              </a-form-item>-->
<!--              <a-form-item class="mb-5" label="当前次数" :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <span class="c-p">{{ record.turntable_nums }}</span>-->
<!--              </a-form-item>-->
<!--              <a-form-item label="充值方式" :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <a-radio-group-->
<!--                  v-decorator="[`${RECHARGE_TYPE_SlYDER}.mode`, { initialValue: 'inc', rules: [{ required: true }] }]"-->
<!--                >-->
<!--                  <a-radio value="inc">增加</a-radio>-->
<!--                  <a-radio value="dec">减少</a-radio>-->
<!--                  <a-radio value="final">最终次数</a-radio>-->
<!--                </a-radio-group>-->
<!--              </a-form-item>-->
<!--              <a-form-item label="变更数量" :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <a-input-number-->
<!--                  v-decorator="[`${RECHARGE_TYPE_SlYDER}.value`, { initialValue: '', rules: [{ required: true, message: '请输入变更的大转盘次数' }] }]"-->
<!--                />-->
<!--              </a-form-item>-->
<!--              <a-form-item label="管理员备注" :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <a-textarea-->
<!--                  placeholder="请输入管理员备注"-->
<!--                  :rows="3"-->
<!--                  v-decorator="[`${RECHARGE_TYPE_SlYDER}.remark`, { rules: [{ required: true, message: '请输入管理员备注' }] }]"-->
<!--                />-->
<!--              </a-form-item>-->
<!--            </template>-->
<!--          </a-tab-pane>-->
...
// 充值类型枚举: 大转盘
const RECHARGE_TYPE_SlYDER = 'turntable'
  ...
  methods: {
    ...
    */
    onFormSubmit (values) {
      ...
      Api.recharge({ id: record.id, target: activeKey, form: values })
        .then((result) => {
          // 显示成功
